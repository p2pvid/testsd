...
class Buckets extends grpc_authentication_1.GrpcAuthentication {
     ...
     * ```
     */
    getOrCreate(name, threadName = 'buckets', isPrivate = false, cid, threadID) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const created = yield this.create(name, isPrivate, cid);
     ...
     * ```
     */
    create(name, isPrivate = false, cid) {
        return __awaiter(this, void 0, void 0, function* () {
            logger.debug('create request');
            return api_1.bucketsCreate(this, name, isPrivate, cid);
        });
    }
    /**
    ...
    archive(key, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return api_1.bucketsArchive(this, key, options);
        });
    }
    /**
