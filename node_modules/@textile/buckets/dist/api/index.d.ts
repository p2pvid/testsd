 ...
 * Bucket root info
 */
export declare type RootObject = {
    key: string;
    name: string;
    path: string;
    createdAt: number;
 ...
 * @internal
 */
export declare function bucketsCreate(api: GrpcConnection, name: string, isPrivate?: boolean, cid?: string, ctx?: ContextInterface): Promise<CreateObject>;
/**
 ...
 * @internal
 */
export declare function bucketsRoot(api: GrpcConnection, key: string, ctx?: ContextInterface): Promise<RootObject | undefined>;
/**
 ...
 * @internal
 */
export declare function bucketsLinks(api: GrpcConnection, key: string, path: string, ctx?: ContextInterface): Promise<LinksObject>;
/**
 ...
 * @internal
 */
export declare function bucketsList(api: GrpcConnection, ctx?: ContextInterface): Promise<Array<RootObject>>;
/**
 ...
 * @internal
 */
export declare function bucketsListPath(api: GrpcConnection, key: string, path: string, ctx?: ContextInterface): Promise<PathObject>;
/**
 ...
 * @internal
 */
export declare function bucketsListIpfsPath(api: GrpcConnection, path: string, ctx?: ContextInterface): Promise<PathItemObject | undefined>;
/**
