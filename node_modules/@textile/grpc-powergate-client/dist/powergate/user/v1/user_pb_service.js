...
UserService.QueuedStorageJobs = {
  methodName: "QueuedStorageJobs",
  service: UserService,
  requestStream: false,
  responseStream: false,
  requestType: powergate_user_v1_user_pb.QueuedStorageJobsRequest,
  responseType: powergate_user_v1_user_pb.QueuedStorageJobsResponse
};

UserService.ExecutingStorageJobs = {
  methodName: "ExecutingStorageJobs",
  service: UserService,
  requestStream: false,
  responseStream: false,
  requestType: powergate_user_v1_user_pb.ExecutingStorageJobsRequest,
  responseType: powergate_user_v1_user_pb.ExecutingStorageJobsResponse
};

UserService.LatestFinalStorageJobs = {
  methodName: "LatestFinalStorageJobs",
  service: UserService,
  requestStream: false,
  responseStream: false,
  requestType: powergate_user_v1_user_pb.LatestFinalStorageJobsRequest,
  responseType: powergate_user_v1_user_pb.LatestFinalStorageJobsResponse
};

UserService.LatestSuccessfulStorageJobs = {
  methodName: "LatestSuccessfulStorageJobs",
  service: UserService,
  requestStream: false,
  responseStream: false,
  requestType: powergate_user_v1_user_pb.LatestSuccessfulStorageJobsRequest,
  responseType: powergate_user_v1_user_pb.LatestSuccessfulStorageJobsResponse
};
...
UserServiceClient.prototype.queuedStorageJobs = function queuedStorageJobs(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(UserService.QueuedStorageJobs, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
UserServiceClient.prototype.executingStorageJobs = function executingStorageJobs(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(UserService.ExecutingStorageJobs, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
UserServiceClient.prototype.latestFinalStorageJobs = function latestFinalStorageJobs(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(UserService.LatestFinalStorageJobs, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
UserServiceClient.prototype.latestSuccessfulStorageJobs = function latestSuccessfulStorageJobs(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(UserService.LatestSuccessfulStorageJobs, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
